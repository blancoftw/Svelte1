<script>
  ...
  $: bord = numbers.length
	...
	function UnCount (idx){
		...
		numbers = numbers.filter((e,i) => idx != i)
	}
</script>
...
button {
  ...
  background-image: url('https://assets.codepen.io/4175254/terrazzo-blue.svg');
  box-shadow: (
    inset 0 2px 2px rgb(255 255 255 / .4),
    inset 0 -2px 1px rgb(0 0 0 / .1),
